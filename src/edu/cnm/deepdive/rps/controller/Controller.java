...
public class Controller {
  ...
  private void initialize() {
    terrain = new Terrain(TERRAIN_SIZE, new Random(), new VonNeumann());
  ...
  private void fitView(ActionEvent actionEvent) {
    if (fitCheckbox.isSelected()) {
      ...
      terrainView.setWidth(defaultViewHeight);
  ...
  public void stop(ActionEvent actionEvent) {
    running = false;
    //TODO Investigate whether the thread should re-enable button when done.
